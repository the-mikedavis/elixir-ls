{ src, lib, elixir, fetchFromGitHub, fetchMixDeps, mixRelease }:
# upstream: https://github.com/NixOS/nixpkgs/blob/master/pkgs/development/beam-modules/elixir-ls/default.nix
